...
object DatabaseData {
    ...
    fun getSampleLesson(): List<Lesson> {
        return listOf(
            // Basic grammar
            Lesson(id = 1, categoryId = 1, name = "Tenses (Verb Forms)"),
            Lesson(id = 2, categoryId = 1, name = "Conditional Sentences"),
            Lesson(id = 3, categoryId = 1, name = "Passive Voice"),
            Lesson(id = 4, categoryId = 1, name = "Reported Speech"),
            Lesson(id = 5, categoryId = 1, name = "Relative Clauses"),
            Lesson(id = 6, categoryId = 1, name = "Phrasal Verbs"),

            // Basic Vocabulary
            Lesson(id = 7, categoryId = 2, name = "Common Words"),
            Lesson(id = 8, categoryId = 2, name = "Numbers & Colors"),
            Lesson(id = 9, categoryId = 2, name = "Basic Phrases"),

            // English for Kids
            Lesson(id = 10, categoryId = 3, name = "Animal Names"),
            Lesson(id = 11, categoryId = 3, name = "Fun with Rhymes"),
            Lesson(id = 12, categoryId = 3, name = "Storytelling"),

            // Business English
            Lesson(id = 13, categoryId = 4, name = "Office Communication"),
            Lesson(id = 14, categoryId = 4, name = "Email Writing"),
            Lesson(id = 15, categoryId = 4, name = "Job Interviews"),

            // Everyday Conversations
            Lesson(id = 16, categoryId = 5, name = "Shopping Dialogues"),
            Lesson(id = 17, categoryId = 5, name = "Making Appointments"),
            Lesson(id = 18, categoryId = 5, name = "Small Talk"),

            // Travel & Tourism
            Lesson(id = 19, categoryId = 6, name = "At the Airport"),
            Lesson(id = 20, categoryId = 6, name = "Hotel Conversations"),
            Lesson(id = 21, categoryId = 6, name = "Ordering Food"),
        )
    }

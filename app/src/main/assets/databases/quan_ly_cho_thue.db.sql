...
CREATE TABLE IF NOT EXISTS "DichVu" (
	...
	"MaPhong"	TEXT,
	PRIMARY KEY("ID"),
	FOREIGN KEY("MaKhuTro") REFERENCES "KhuTro"("ID"),
...
CREATE TABLE IF NOT EXISTS "HopDong" (
	...
	"GhiChu"	TEXT,
	PRIMARY KEY("ID"),
	FOREIGN KEY("MaKhach") REFERENCES "NguoiThue"("ID"),
	FOREIGN KEY("MaPhong") REFERENCES "Phong"("ID")
);
CREATE TABLE IF NOT EXISTS "KhieuNai" (
	...
	PRIMARY KEY("ID"),
	FOREIGN KEY("MaPhong") REFERENCES "Phong"("ID"),
	FOREIGN KEY("NguoiNop") REFERENCES "NguoiThue"("ID")
);
CREATE TABLE IF NOT EXISTS "KhuTro" (
	...
	"MaChuNha"	TEXT NOT NULL,
	"TrangThai"	INTEGER DEFAULT 1,
	"MoTa"	TEXT,
	PRIMARY KEY("ID"),
	FOREIGN KEY("MaChuNha") REFERENCES "NguoiDung"("ID")
);
...
INSERT INTO "HoaDon" ("ID","NgayTao","GiaThue","SONUOC","SODIEN","GiaDichVu","TienMienGiam","TongTien","TrangThai","MaPhong","Thang","Nam","GhiChu") VALUES ('50AD585705187B48900219F47525D5D6','2023-01-01',3000000.0,10,100,NULL,'0',NULL,0,'472A9121AFDBDBF23B15D3C778332BBF',1,2023,'Ghi chú 1'),
 ('049B0D46086F478C0008DDD15D5C9DD0','2023-02-01',4000000.0,15,150,NULL,'0',NULL,1,'61DE95DF73EEF4B7C0F19F9FF49BB707',2,2023,'Ghi chú 2');
INSERT INTO "HopDong" ("ID","ThoiHan","NgayLapHopDong","NgayBatDau","NgayKetThuc","TienCoc","TrangThai","HieuLuc","MaPhong","MaKhach","GhiChu") VALUES ('AED8093BBE849C5AA49C900148EA8E36',12,'2025-01-01','2025-02-01','2026-01-31','5000000',1,1,'472A9121AFDBDBF23B15D3C778332BBF','776361F08BC4EA1984DCCFF869332FB3','Hợp đồng 1'),
 ('6B57DF7F1A58CFDBE9B56E6F7B5EFAB2',6,'2025-01-15','2025-02-15','2025-08-14','3000000',1,1,'61DE95DF73EEF4B7C0F19F9FF49BB707','EBFF48CF61E0EBAEDE3E4EB9C21CFC29','Hợp đồng 2'),
 ('B4905F7D20D594FB54B3283807A24EF1',24,'2025-01-20','2025-02-20','2027-02-19','1000000',1,1,'53BBFAA6EF5163CF02DB9AB4A82D660A','B3CD8EE2B3FAAF6043078A17CFF88B44','Hợp đồng 3');
INSERT INTO "KhieuNai" ("ID","TieuDe","NoiDung","NgayTao","NguoiNop","MaPhong","TrangThai") VALUES ('6AA76D38AF74E86777B8314A1C200468','Khiếu nại 1','Nội dung khiếu nại 1','2023-01-01 10:00:00','776361F08BC4EA1984DCCFF869332FB3','472A9121AFDBDBF23B15D3C778332BBF','Mới'),
 ('6640A9A9277195EB0479C4C25BC90E6F','Khiếu nại 2','Nội dung khiếu nại 2','2023-02-01 11:00:00','EBFF48CF61E0EBAEDE3E4EB9C21CFC29','61DE95DF73EEF4B7C0F19F9FF49BB707','Đang xử lý');
